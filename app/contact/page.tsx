            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">support@cribeasyapp.com</p>
                    <p className="text-gray-600">info@cribeasyapp.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="https://twitter.com/cribeasy" 
                    target="_blank" 
                  ...
                  <a 
                    href="https://facebook.com/cribeasy" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white transition-colors"
                    style={{ backgroundColor: '#f3f4f6' }}
                  ...
                  <a 
                    href="https://linkedin.com/company/cribeasy" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white transition-colors"
                    style={{ backgroundColor: '#f3f4f6' }}
                  ...
                  <a 
                    href="https://tiktok.com/@cribeasy" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white transition-colors"
                    style={{ backgroundColor: '#f3f4f6' }}
